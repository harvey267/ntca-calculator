...
Verified against two official NTCA Pension Point outputs across two retirement dates:
...
Monthly annuity matches exactly on both dates. Errors are bidirectional (average: $1.09), ruling out systematic model bias. The remaining gap is input precision — NTCA carries salary and service years to more decimal places internally than they display on output PDFs. Closing it further would require their unrounded internal data.
